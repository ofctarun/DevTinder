...
const NavBar = () => {
  ...
  //1,2,3 -> only to acheive theme shift in all browsers
  
  // 1. Initialize theme from localStorage safely
  ...
  return (
    <div className="navbar bg-base-100 shadow-sm px-4">
      <div className="flex-1">
        <Link to="/" className="btn btn-ghost text-xl font-black italic">
          DEVTINDER👨🏻‍💻
        </Link>
      </div>
        ...
        {user && (
          <div className="flex gap-4 items-center">
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-50 mt-3 w-52 p-2 shadow-2xl border border-base-300">
                <li className="menu-title font-bold text-xs uppercase opacity-50">Account</li>
                <li><Link to="/profile">My Profile</Link></li>
                <li><Link to="/edit-profile">Edit Profile</Link></li>
                <div className="divider my-0"></div>
                <li className="menu-title font-bold text-xs uppercase opacity-50">Social</li>
